...
\begin{proof}
    ...
    \begin{align*}
        \int_{I_n} a(t; u_{h \tau}(t), u_{h \tau}(t)) ~ d \lambdaGR_{q + 1} &= \sum_{i = 1}^{q + 1} \omega_{n, i} a(t_{n, i}; u_{h \tau}(t_{n, i}), u_{h \tau}(t_{n, i})) \\
        &\geq \CoerC{a} \sum_{i = 1}^{q + 1} \omega_{n, i} \Norm{ u_{h \tau}(t_{n, i}) }_V^2 \\
        &= \CoerC{a} \int_{I_n} \Norm{ u_{h \tau}(t) }_V^2 ~ d \lambda,
    \end{align*}
    ...
    \begin{align*}
        \sum_{n \in \TimeIndices} &\left( \int_{I_n} \left( \partial_t u_{h \tau}(t), u_{h \tau}(t) \right)_W ~ d \lambda + \left( \llbracket u_{h \tau} \rrbracket_{n - 1}, u_{h \tau}(t_{n - 1}^+) \right)_W \right) \\
...
\begin{proof}
    ...
    \begin{align*}
        \int_{I_n} \left( \partial_t \delta, y_{\tau} \right)_W ~ d \lambda &= - \int_{I_n} \left( \delta, \partial_t y_{\tau} \right)_W ~ d \lambda + \left( \delta(t_n), y_{\tau}(t_n) \right)_W - \left( \delta(t_{n - 1}^+), y_{\tau}(t_{n - 1}^+) \right)_W \\
    ...
    hence:
    \begin{align*}
        \int_{I_n} \left( \partial_t \delta, y_{\tau} \right)_W ~ d \lambda &= - \left( \delta(t_{n - 1}^+), y_{\tau}(t_{n - 1}^+) \right)_W = \left( \llbracket \InterpolantQT(u) \rrbracket_{n - 1}, y_{\tau}(t_{n - 1}^+) \right)_W.
    \end{align*}
\end{proof}
