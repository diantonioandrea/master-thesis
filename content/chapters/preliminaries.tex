...
\begin{align}
    ...
    \mu(\Omega_n) & < +\infty \quad \text{ for all } n \in \NaturalNumbers.
\end{align}

\begin{definition}[$\SpaceLp{1}(\Omega, \SigmaAlgebraA, \mu)$]
    \begin{gather}
...
\begin{theorem}[Beppo Levi, or monotone convergence]
    ...
    \begin{align}
        & 0 \leq f_1(\Vector{x}) \leq \dots \leq f_n(\Vector{x}) \leq \dots < +\infty \quad \text{ for } \mu \text{-a.e. } \Vector{x} \in \Omega, \\
...
\begin{lemma}[Fatou]
    Let $\left\{ f_n \right\}_{n \in \NaturalNumbers} \subset \SpaceLp{1}(\Omega)$ such that:
    \begin{align}
        f_n(x) & \geq 0 \quad \text{ for } \mu \text{-a.e. } \Vector{x} \in \Omega, \\
        \sup_{n \in \NaturalNumbers} \int_{\Omega} f_n(\Vector{x}) ~ d \mu & < +\infty,
    \end{align}
    then:
    \begin{gather}
...
\begin{theorem}[Morrey's inequality]
    ...
    \begin{gather}
        \lvert u(\Vector{x}) - u(\Vector{y}) \rvert \leq C \lVert \Vector{x} - \Vector{y} \rVert^{\alpha} \lVert \Gradient u \rVert_p \quad \text{ for } \mu \text{-a.e. } \Vector{x}, \Vector{y} \in \RealNumbersTo{d},
    \end{gather}
    where:
    \begin{gather}
        \alpha = 1 - \frac{d}{p}.
...
\begin{corollary} \label{corollary:embedding}
    ...
    and
    \begin{gather}
        \lvert \partial^{\alpha} u(\Vector{x}) - \partial^{\alpha} u(\Vector{y}) \rvert \leq C \lVert \Vector{x} - \Vector{y} \rVert^{\theta} \lVert u \rVert_{k, p} \quad \text{ for } \mu \text{-a.e. } \Vector{x}, \Vector{y} \in \RealNumbersTo{d}.
    \end{gather}
...
\begin{corollary}
    ...
    \begin{gather}
        \lvert u(\Vector{x}) - u(\Vector{y}) \rvert \leq C \lVert \Vector{x} - \Vector{y} \rVert^{\alpha} \lVert u \rVert_{1, p} \quad \text{ for } \mu \text{-a.e. } \Vector{x}, \Vector{y} \in \RealNumbersTo{d},
    \end{gather}
    where:
    \begin{gather}
        \alpha = 1 - \frac{d}{p}.
