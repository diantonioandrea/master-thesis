...
Let $(\Omega, \MA, \mu)$ denote a measure space where $\Omega \subseteq \Rd$, $\MA$ is a $\sigma$-algebra in $\Omega$ and $\mu$ is a measure. Assume that $\Omega$ is $\sigma$-finite, that is there exist $\left\{ \Omega_n \right\}_{n \in \N} \subset \MA$ such that:
\begin{gather}
