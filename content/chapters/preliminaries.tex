...
This space allows for the definitions presented in the following sections.
...
\begin{theorem}[Stampacchia]
    Let $a \colon H \times H \rightarrow \RealNumbers$ be a continuous and coercive bilinear form on $H$ and let $K \subset H$ be a nonempty closed and convex subset, then, for all $\varphi \in H^*$, there exists a unique $u \in K$ such that, for all $v \in H$:
    \begin{align}
...
\begin{corollary}[Lax-Milgram] \label{theorem:lm}
    Let $a \colon H \times H \rightarrow \RealNumbers$ be a continuous and coercive bilinear form on $H$, for all $\varphi \in H^*$, there exists a unique $u \in H$ such that, for all $v \in H$:
    \begin{align}
...
\begin{corollary}
    \begin{align}
        \SpaceWkp{1}{d}(\RealNumbersTo{d}) &\hookrightarrow \SpaceLp{q}(\RealNumbersTo{d}) &\text{ for all } d \leq q < +\infty.
    \end{align}
\end{corollary}
...
\begin{theorem}[Rellich-Kondrachov]
    ...
    In particular:
    \begin{align}
        \SpaceWkp{1}{p}(\Omega) \hookrightarrow \hookrightarrow \SpaceLp{p}(\Omega).
    \end{align}
\end{theorem}
