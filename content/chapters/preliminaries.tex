...
\begin{definition}[Continuous bilinear form]
    A bilinear form $a \colon H \times H \rightarrow \RealNumbers$ is said to be continuous if there exists $C \geq 0$ such that for all $u, v \in H$:
    \begin{gather}
...
\begin{definition}[Coercive bilinear form]
    A bilinear form $a \colon H \times H \rightarrow \RealNumbers$ is said to be coercive if there exists $\alpha > 0$ such that for all $u \in H$:
    \begin{gather}
