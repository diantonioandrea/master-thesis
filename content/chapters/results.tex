...
Graphs in \Cref{sec:graphs_1,sec:graphs_2}, particurarly for the pairs $\left( 1, 1 \right)$ and $\left( 2, 2 \right)$, highlights the correct and expected error trend for for all the considered norms. Graphs for the $\left( 2, 1 \right)$ case, \cpageref{graph:2_1_par_l2l2,graph:2_1_hyp_l2l2}, show the importance of the choices for the $\SpaceLp{2}(\left\{ T \right\} \times \Omega)$ and $\SpaceLp{\infty}(I; \SpaceLp{2}(\Omega))$ norms.