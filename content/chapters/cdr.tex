...
\begin{align} % [!] Fix alignment and (?) u(0).
    &\sum_{n \in \TimeIndices} \int_{I_n} \left( (u_{h, \tau}, \varphi )_0 + A_{h, n}(u_{h, \tau}, \varphi) \right) ~ d \lambda(t) \notag + \sum_{n = 2}^{\nTimeIndices} (\left\{ u_{h, \tau} \right\}_{n - 1}, \varphi_{n - 1}^+ )_0 + (u_{h, \tau}(0), \varphi_0^+ )_0 \notag \\
...
\begin{align}
    B(u, \varphi) &= \sum_{n \in \TimeIndices} \int_{I_n} \left( (u, \varphi )_0 + A_{h, n}(u, \varphi) \right) ~ d \lambda(t) + \sum_{n = 2}^{\nTimeIndices} (\left\{ u \right\}_{n - 1}, \varphi_{n - 1}^+ )_0 + (u(0), \varphi_0^+ )_0, \label{equation:cdr_B} \\
