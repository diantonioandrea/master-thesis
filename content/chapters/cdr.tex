...
The discontinuous Galërkin semi-discrete problem is to find an approximate solution $u_h \in C^1(I; \SpaceSolution_h^p)$ of \eqref{equation:cdr} with initial-boundary conditions \eqref{equation:cdr_dirichlet}, \eqref{equation:cdr_neumann}, \eqref{equation:cdr_initial}, such that:
\begin{align}
