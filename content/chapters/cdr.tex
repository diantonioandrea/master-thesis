...
\begin{lemma}
    \begin{align}
        ...
        &+ \BoundQ \frac{\tau_n}{2} \lVert \partial_t \left( \InterSol u \right) - \partial_t \varphi \rVert_{\SpaceLp{2}(I_n; \SpacePlaceholder)}, \notag
    \end{align}
    for all $\varphi \in \SpaceSolutionFull$\footnote{$\InterPolyN$ denotes the $\SpaceLp{2}$ projection onto $\SpacePolynomials{q}(I_n)$.}.
\end{lemma}
