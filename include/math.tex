...
\newcommand{\SpaceSolutionH}{\mathscr{S}_h} % Approximate solution space (space).
\newcommand{\SpaceSolutionHT}{\mathscr{S}_{h, \tau}} % Approximate solution space (space-time).
...
% Constants.
\newcommand{\BoundC}[1]{\beta_{#1}} % Bounding.
